...
- **`Konzept-Begleit-Apps.md`** — wiederverwendbare Blaupause, um ähnliche Apps zu
  anderen Themen zu bauen.

## Hosten über GitHub Pages

1. Repo anlegen, diese Dateien hochladen (App als `index.html`).
1. Settings → Pages → Source: Branch `main`, Ordner `/ (root)` → Save.
1. Nach kurzer Zeit ist die App erreichbar unter
...
Die App ist eine warme Ergänzung, **kein Ersatz** für Therapie oder einen Notfallplan.
Designprinzipien und Sicherheits-Leitplanken stehen in `CLAUDE.md` — bitte respektieren.